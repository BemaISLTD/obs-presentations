import { profileCards, renderTailwindForeground, renderTailwindUnderlay } from './tailwindBroadcastScene.jsx'

// Scene 28 owns these design primitives so it can be edited independently.
const ICONS = {
...
const config = {
    ...
    items: [
      { ...card('Amina Diallo', 'Youth Mentor & Creative Educator', 'people', '1.2K', 'cyan', 'changemaker-1'), image: '/assets/generated/changemaker-amina.png' },
      { ...card('Marcus Reed', 'Impact Strategist & Movement Leader', 'chart', '1.1K', 'blue', 'changemaker-2'), image: '/assets/generated/changemaker-marcus.png' },
      { ...card('Jordan Miles', 'Community Builder & Social Entrepreneur', 'heart', '980', 'purple', 'changemaker-3'), image: '/assets/generated/changemaker-jordan.png' },
      { ...card('Sophia Lee', 'Climate Advocate & Sustainability Leader', 'signal', '870', 'cyan', 'changemaker-4'), image: '/assets/generated/changemaker-sophia.png' },
      { ...card('Tierra Vaughn', 'Creative Director & Visual Storyteller', 'music', '1.6K', 'purple', 'changemaker-5'), image: '/assets/generated/changemaker-tierra.png' },
      { ...card('Darnell Brooks', 'UX Designer & Tech for Good Advocate', 'people', '1.3K', 'blue', 'changemaker-6'), image: '/assets/generated/changemaker-darnell.png' },
    ],
...
export const scene28 = {
  presenterZone: 'left',
  renderUnderlay() {
    return renderTailwindUnderlay({ title: config.title, subtitle: config.subtitle, body: profileCards(config.items) })
  },
  renderForeground() { return renderTailwindForeground(['♙ Changemakers', '♡ Meaningful Impact', '▶ Real Stories', '⌁ Community Movement']) },
}
