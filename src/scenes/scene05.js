...
export const scene05 = {
  ...
  renderUnderlay(context) {
    ...
    return `<section class="scene scene05"><img class="scene-brand-wordmark" src="${ASSET_PATHS.logos.wordmark}" alt="BemaHub"><div class="scene-live-chip"><span></span>LIVE</div><div class="scene05-presenter-space" aria-label="Presenter camera placement"></div><div class="scene05-layout"><div class="scene05-title-wrap"><h2>BEMA HUB<br>OPEN ENROLLMENT</h2><div class="scene05-year-row"><span></span><strong>2026</strong><span></span></div><p>Better Benefits. Stronger Together.</p></div><div class="scene05-right-stack"><section class="scene05-agenda-panel"><h3>TODAY'S AGENDA</h3><ol class="scene05-agenda-list">${agendaRows}</ol></section><section class="scene05-cta-panel"><p class="scene05-cta-title">Big insights. Builder next steps. Live enrollment.</p><p class="scene05-cta-copy">Key insights, Builder next steps, and live enrollment await.</p></section></div></div></section>`
  },
  renderForeground(context) { return `<section class="scene-foreground scene05-foreground">${renderTicker(context.ticker.scene05, 'local')}</section>` },
