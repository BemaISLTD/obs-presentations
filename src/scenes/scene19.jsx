// Scene 19 owns these design primitives so it can be edited independently.
const ICONS = {
  people:
  ...
  diamond:
    '<svg viewBox="0 0 24 24"><path d="m3 8 4-5h10l4 5-9 13L3 8Zm0 0h18M7 3l5 18 5-18M8 8l4-5 4 5"/></svg>',
  crown:
...
const config = {
  title: "CHOOSING YOUR ACCESS LEVEL",
  subtitle: "Find the path that fits your campaign experience.",
  layout: "cards",
  items: [
    card(
      "Participation Level",
      "Unlock core campaign value and essential participation assets to get started.",
      "people",
      "Start. Engage. Grow.",
      "cyan",
      "level-participation",
    ...
    card(
      "VIP Access",
      "Unlock deeper creator experiences and exclusive assets for greater impact.",
      "crown",
      "Go Deeper. Do More.",
      "purple",
      "level-vip",
    ...
    card(
      "Signature VIP",
      "Unlock the deepest access, exclusive assets, and identity-based participation.",
      "diamond",
      "Lead. Legacy. Elevate.",
      "amber",
      "level-signature",
  ...
  footer: [
    ["people", "Choose Access Level"],
    ["people", "Participation Level"],
    ["crown", "VIP Access"],
    ["diamond", "Signature VIP"],
  ],
};
export const scene19 = {
  ...
  renderUnderlay() {
    return renderLayeredUnderlay(
      "19",
      config,
      renderFeatureCards("19", config),
    );
  },
  renderForeground() {
    return renderLayeredForeground("19", config);
  },
};
