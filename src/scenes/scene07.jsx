// Scene 07 owns these design primitives so it can be edited independently.
const ICONS = {
  people:
  ...
  sprout:
    '<svg viewBox="0 0 24 24"><path d="M12 21V9M12 12c-5 0-8-2.5-8-7 5 0 8 2.3 8 7Zm0 3c5 0 8-2.5 8-7-5 0-8 2.3-8 7ZM7 21h10"/></svg>',
};
...
const config = {
  title: "WHAT IS BEMA CORE?",
  subtitle: "Community of Rewarded Engagement.",
  layout: "cards",
  items: [
    card(
      "Mutual Exchange",
      "Participants access real creative value.",
      "refresh",
      "",
      "cyan",
      "pillar-exchange",
    ...
    card(
      "Builders in Action",
      "Builders help that value reach more people.",
      "people",
      "",
      "blue",
      "pillar-builders",
    ...
    card(
      ...
      "Creators gain a stronger path to keep creating.",
      "sprout",
      "",
      "purple",
      "pillar-economy",
  ...
  footer: [
    ["heart", "Mutual Exchange"],
    ["people", "Builders in Action"],
...
export const scene07 = {
  ...
  renderUnderlay() {
    return renderLayeredUnderlay(
      "07",
      config,
      renderFeatureCards("07", config),
    );
  },
  renderForeground() {
    return renderLayeredForeground("07", config);
  },
};
