// Scene 25 owns these design primitives so it can be edited independently.
const ICONS = {
...
const config = {
    title: 'TRUST & TRANSPARENCY', subtitle: 'Clear rules. Verified movement. Open communication.', layout: 'cards',
    items: [
