// Scene 10 owns these design primitives so it can be edited independently.
const ICONS = {
  people:
  ...
  access:
    '<svg viewBox="0 0 24 24"><circle cx="9" cy="7" r="3"/><path d="M3 20c.4-4.2 2.4-6.3 6-6.3 2.3 0 4 .8 5 2.4M15 12l1.5-4 2 2 2.5-2-1 5h-5Z"/></svg>',
  download:
    '<svg viewBox="0 0 24 24"><path d="M6 2h8l4 4v9H6V2Zm8 0v5h5M12 9v10m0 0-4-4m4 4 4-4M4 21h16"/></svg>',
  crown:
...
const config = {
  ...
  subtitle: "How a Builder moves through the experience.",
  layout: "flow",
  items: [
    card(
      "Choose Access Level",
      "Select the campaign experience that fits.",
      "access",
      "1",
      "blue",
      "journey-1",
    ...
    card(
      "Receive Participation Assets",
      "Unlock creator value and experiences.",
      "download",
      "2",
      "blue",
      "journey-2",
    ...
    card(
      "Activate LoopLink or LoopCode",
      "Use your personal participation tools.",
      "link",
      "3",
      "blue",
      "journey-3",
    ...
    card(
      "Another Person Participates",
      "A confirmed participation creates a LoopLock.",
      "people",
      "4",
      "purple",
      "journey-4",
    ...
    card(
      "Loop Activity Grows",
      "Your verified movement becomes visible.",
      "chart",
      "5",
      "purple",
      "journey-5",
  ...
  callout:
    "Each confirmed participation through your LoopLink or LoopCode becomes a LoopLock.",
  footer: [
    ["access", "Participation Journey"],
    ["crown", "Choose Access Level"],
    ["link", "LoopLink"],
    ["chart", "Loop Activity"],
  ],
};
export const scene10 = {
  presenterZone: "left",
  renderUnderlay() {
    return renderLayeredUnderlay("10", config, renderFlow("10", config));
  },
  renderForeground() {
    return renderLayeredForeground("10", config);
  },
};
